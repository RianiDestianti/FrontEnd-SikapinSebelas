          ...
          activities.asMap().entries.map((entry) {
              ...
              switch (type) {
                ...
                case 'Pelanggaran':
                  ...
                  gradient = [const Color(0xFFFF6B6D), const Color(0xFFFF8E8F)];
                  statusColor = const Color(0xFFFF6B6D);
                  break;
                default:
                  icon = Icons.assessment_outlined;
                  gradient = [const Color(0xFF61B8FF), const Color(0xFF0083EE)];
                  statusColor = const Color(0xFF0083EE);
                  break;
              }
                                        ...
                                        child: Dismissible(
                                          ...
                                          onDismissed: (direction) {
                                            ...
                                            ScaffoldMessenger.of(
                                              ...
                                              SnackBar(
                                                content: Text(
                                                  'Aktivitas "${activity.title}" dihapus',
                                                ...
                                                action: SnackBarAction(
                                                  ...
                                                  onPressed: () async {
                                                    ...
                                                    String activityString =
                                                        '${activity.type}|${activity.title}|${activity.subtitle}|${activity.fullDate.toString().split('.')[0]}';
                                                    activities.insert(
                                                      activity.id - 1,
                                                      activityString,
                                                    );
