...
class _HistoryScreenState extends State<HistoryScreen>
  ...
  // Combined data history with isNew flag
  ...
  void initState() {
    ...
    // Sort history: new items first, then by date
    _sortHistory();
  ...
  List<Map<String, dynamic>> _getFilteredHistory() {
    ...
    // Filter by type (Semua, Apresiasi, Pelanggaran)
    ...
    if (_selectedTimeFilter != 'Semua') {
      ...
      filtered =
          filtered
              .where((item) => item['createdAt'].isAfter(filterDate))
              .toList();
    }

    // Filter new items only
    if (_showOnlyNew) {
      filtered = filtered.where((item) => item['isNew'] == true).toList();
    }
  ...
  // Function untuk menampilkan dialog edit
  ...
  Widget build(BuildContext context) {
    ...
    List<Map<String, dynamic>> newItems =
        filteredHistory.where((item) => item['isNew'] == true).toList();
    List<Map<String, dynamic>> oldItems =
        filteredHistory.where((item) => item['isNew'] == false).toList();
